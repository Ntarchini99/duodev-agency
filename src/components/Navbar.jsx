...
const Header = () => {
  ...
  return (
    <header className={`flex items-center justify-between xl:justify-start w-full py-4 px-8 h-[10vh] z-50 ${showMenu ? "fixed top-0" : ""}`}>
      ...
      <nav className={`bg-white w-[80%] md:w-[40%] xl:w-full h-full ${showMenu ? "left-0" : "-left-full"} top-0 xl:static flex-1 flex flex-col xl:flex-row items-center justify-center gap-10 transition-all duration-500 z-50`}>
