...
const Header = () => {
  ...
  return (
    <header className={`flex items-center justify-between w-full py-2 px-4 z-50 fixed top-0 bg-white shadow-md`}>
      ...
      <nav className={`bg-white w-full md:w-[80%] xl:w-full h-full xl:static flex-1 flex flex-col xl:flex-row items-center justify-center transition-all duration-500 z-50 ${showMenu ? "fixed top-16 left-0" : "hidden xl:flex"}`}>
